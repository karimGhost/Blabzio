...
const firebaseConfig7={apiKey:"AIzaSyBL9EyNItdif__jADl2m8rx5TFMBXFl6NE",authDomain:"zenaitsworld.firebaseapp.com",projectId:"zenaitsworld",storageBucket:"zenaitsworld.appspot.com",messagingSenderId:"752059821465",appId:"1:752059821465:web:a892347312cbfad858f708",measurementId:"G-GEMHBSGYPY"};const firebaseConfig16191={// Your Firebase configuration here
apiKey:"AIzaSyDiegssGy9vROHCfVsCDNrPCJrbilonB-U",authDomain:"compo-57c97.firebaseapp.com",databaseURL:"https://compo-57c97-default-rtdb.firebaseio.com",projectId:"compo-57c97",storageBucket:"compo-57c97.appspot.com",messagingSenderId:"475037571261",appId:"1:475037571261:web:9db4f4bdd540a72bbb3fd4"};const firebaseConfig10122={apiKey:"AIzaSyBh8ygMi8nTJ7WVcA9amKSwABs_NzJZQk4",authDomain:"chatszen.firebaseapp.com",databaseURL:"https://chatszen-default-rtdb.firebaseio.com",projectId:"chatszen",storageBucket:"chatszen.appspot.com",messagingSenderId:"83570132385",appId:"1:83570132385:web:b9d0772699726c7bb4f7e0",measurementId:"G-4S4BTTXP48"};function Magazine(){const{user,loading,signOut}=(0,_Accounts_useAuth__WEBPACK_IMPORTED_MODULE_15__/* .useAuth */ .a)();firebase_compat_app__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.initializeApp(firebaseConfig7,'app7');const app7=firebase_compat_app__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.app('app7');(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{aos__WEBPACK_IMPORTED_MODULE_11___default().init();},[]);const{0:saved,1:setSaved}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);const isBloged=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(true);/*
...
const handlePageChange=page=>{if(page<=totalPages){setCurrentPage(page);}};firebase_compat_app__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.initializeApp(firebaseConfig10122,'app1312');const app1212=firebase_compat_app__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.app('app1312');const databaseSavedNews=app1212.database();const savedItemsRef=user&&databaseSavedNews.ref(`savedNews/${user.uid}`);const app1919=firebase_compat_app__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.initializeApp(firebaseConfig16191,'app1819');const database=app1919.database();function saveit(item,urls){const dats=urls;const val=item.title.replace(/[.#$\[\]]/g," ");const isSaved=saved[val]||false;setSaved({...saved,[val]:!isSaved});const sanitizedLink=dats.replace(/[.#$[\]]/g,'_');database.ref(sanitizedLink).on('value',snapshot=>{const snap=snapshot.val();savedItemsRef.child(val).once('value',snapshot=>{if(snapshot.exists()){savedItemsRef.child(val).remove();}else{savedItemsRef.child(val).set(snap);}});});}(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(!savedItemsRef){return;}const onDataChange=snapshot=>{const savedData=snapshot.val();if(savedData){const titles=savedData;setSaved(titles);}else{setSaved({});}};savedItemsRef.on('value',onDataChange);return()=>{savedItemsRef.off('value',onDataChange);};},[user]);// Get the news items for the current page
