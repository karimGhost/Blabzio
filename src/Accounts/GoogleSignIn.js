...
const app1 = firebase.app('app1'); */
  ...
  useEffect(() => {
    if (!appInitialized) {
      firebase.initializeApp(firebaseConfig2, 'app06');
...
<>    
           ...
           {/* <button  id="google-bt" className={log.firstGmail} onClick={GoogleSignIn}><FaGoogle id="btt"/>Continue with Google</button> */}
