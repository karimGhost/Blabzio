...
firebase.initializeApp(firebaseConfig1012, 'app1312');
...
const app1919 = firebase.initializeApp(firebaseConfig1619, 'app1819');
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Entertainent</Trans>}  />
    }
...
export const Head = () => <title>Entertainment</title>