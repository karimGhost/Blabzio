...
export default function Art() {
  ...
  firebase.initializeApp(firebaseConfig1312, 'app1312');
...
const app1919 = firebase.initializeApp(firebaseConfig1819, 'app1819');
...
function saveit(item, urls) {
  const dats = urls;
  const isSaved = saved[item.title] || false;
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Art</Trans>}  />
    }
