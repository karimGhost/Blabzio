...
firebase.initializeApp(firebaseConfig14127, 'app1312');
...
const app1919 = firebase.initializeApp(firebaseConfig16198, 'app1819');
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Travel</Trans>}  />
    }
...
export const Head = () => <title>Travel</title>