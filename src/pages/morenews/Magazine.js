...
firebase.initializeApp(firebaseConfig10122, 'app1312');
...
const app1919 = firebase.initializeApp(firebaseConfig16191, 'app1819');
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Magazine</Trans>}  />
    }
...
export const Head = () => <title>Magazine</title>