...
export default function Trending() {
  ...
  firebase.initializeApp(firebaseConfig14128, 'app1312');
  ...
  const app1919 = firebase.initializeApp(firebaseConfig16199, 'app1819');
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Trending</Trans>}  />
    }
