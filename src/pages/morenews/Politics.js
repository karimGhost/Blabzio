...
firebase.initializeApp(firebaseConfig10123, 'app1312');
...
const app1919 = firebase.initializeApp(firebaseConfig16193, 'app1819');
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Politics</Trans>}  />
    }
...
export const Head = () => <title>Politics</title>