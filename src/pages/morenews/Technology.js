...
firebase.initializeApp(firebaseConfig14125, 'app1312');
...
const app1919 = firebase.initializeApp(firebaseConfig16196, 'app1819');
...
// Setup Firebase realtime for data Realtime Database
  ...
  useEffect(() => {
    app7.database().ref('Technology').on('value', snapshot => {
...
const [dark, setDark] = useState(false)     
    ...
    if(!news){
      return <Loadings  head ={<Trans>Technology</Trans>}  />
    }
...
export const Head = () => <title>Technology</title>