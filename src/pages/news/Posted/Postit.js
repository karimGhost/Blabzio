...
<PagesData off={off}  />
  ...
  <main id="mai mt-6 " className={` ${ dark && "darken bgdar", isprof && "proff" }`} style={{  marginTop: !onHide && "0", overflow: !onHide && "hidden", position: !onHide && "fixed", top: "0", bottom:"0",zIndex: "10", background: dark ? "#121212": "rgba(250, 250, 250, 250)"    , margin: isBlogActive  &&  " 0px", padding: isBlogActive &&"0px",  }}  >
