import React, { useRef, useState, useEffect } from 'react';
  ...
  // Wrap the import in a dynamic import() to handle SSR
  const ReactMediaRecorderDynamic = React.lazy(() => import('react-media-recorder'));
  ...
  export default function SharedPosts() {
    ...
    return (
      <div>
        ...
        <div>
          {/* Use ReactMediaRecorderDynamic instead of ReactMediaRecorder */}
          <React.Suspense fallback={<div>Loading...</div>}>
            <ReactMediaRecorderDynamic
              // Other props...
