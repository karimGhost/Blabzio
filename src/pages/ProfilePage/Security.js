                        ...
                        <>
                           {/* Form Group (current password) */}
                            <div className="mb-3">
                                ...
                                <Password  feedback={false} className='pass mb-4  center' id='form1' value={currentPassword}  onChange={(event) => { setCurrentPassword(pre => event.target.value )  }}  placeholder="Enter current password" toggleMask />
